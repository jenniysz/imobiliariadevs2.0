...
<?php if (isset($_GET['nome'])) { 
    ...
    echo "<a href='login/login.php'>Bem-vindo, " . $nome . "!</a>"; 
} else { 
    echo 'Bem-vindo<a href="login/login.php">Login</a>'; 
} 
?></li>
    ...
    <section class="corretores-sect" id="corretores">
        ...
        <div>
            ...
            <div class="corretores"><img src="img/corretores/felipe.jpg" alt="felipe" class="imagem"> <!-- Felipe -->
                <ul class="conteudo">
                    <li><a href="https://www.instagram.com/cunhalimafelipe/" target="_blank" rel="external"><img
                                src="img/icones/icone-instagram.png" alt="Instagram">
                            <p>//Instagram</p>
                        </a></li>

                    <li><a href="https://wa.me/83996683914" target="_blank" rel="external"><img
                                src="img/icones/icone-whatsapp.png" alt="WhatsApp">
                            <p>//WhatsApp</p>
                        </a></li>
                    ...
                    <li><a href="https://github.com/Felipe891" target="_blank" rel="external"><img
                                src="img/icones/icone-github.png" alt="Git">
                            <p>//Git Hub</p>
                        </a></li>
                </ul>
